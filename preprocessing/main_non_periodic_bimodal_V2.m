...
N1 =  200;  %[50 75   80  100  200]
N2 = 2000;  %[50 200 500 1000 2000]
...
% P = [0 0 0 0 0.4]
P2 = 0.4;                    % Probability constraint to reduce number of long bonds
...
min_node_sep               = 0.5;                   % HARD minimum spacing between any 2 nodes 0.30
...
% Output files
lammps_data_file   = 'PronyNetwork_10000.txt';
lammps_visual_file = 'PronyVisual_10000.dat';
