function [x,y,id,ty,mol,natoms,bAtom1,bAtom2,bType,bLength,bForce,xlims,ylims,zlims] = parse_equidump_full_fun(afile,bfile)
...
while 1 == 1
    ...
    % Read the rest of the file 
    C = textscan(fid,'%u %u %u %f %f %d %f %f %f %f');
